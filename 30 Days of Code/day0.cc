...
Task
To complete this challenge, you must save a line of input from stdin to a variable, print  on a single line, and finally print the value of your variable on a second line.
