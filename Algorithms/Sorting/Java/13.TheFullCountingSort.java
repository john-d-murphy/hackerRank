...
In cases where you care about the original order, it is important to use a stable sorting algorithm. In this challenge,
you will use counting sort to sort a list while keeping the order of the strings (with the accompanying integer)
preserved.

Challenge
In the previous challenge, you created a "helper array" that contains information about the starting position of each
element in a sorted array. Can you use this array to help you create a sorted array of the original list?
...
Explanation
Below is the list in the correct order. The strings of each number were printed above for the second half of the array.
...
public class Solution {
  ...
  public static void main(String[] args) {
    ...
    // Need to use a stringbuilder, as string creation/destruction is too slow
    ...
    for(int i = 0; i < n; i++) {
      ...
      String text = (i < n/2) ? "-" : line[1];

      output.get(index).append(text).append(" ");
    }
